...
/// </summary>
public class DragonBlue : MonoBehaviour, IRaider
{
    ...
    public float manaIncrease = 300f;
    ...
    void FixedUpdate()
    {
        ...
        else if (canSwing && alive && activated) //increase Mana
        {
    ...
    /// <summary>
    /// Timer used for manaregeneration.
    /// </summary>
