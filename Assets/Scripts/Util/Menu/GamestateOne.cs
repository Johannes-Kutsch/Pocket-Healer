...
/// </summary>
public class GamestateOne : MonoBehaviour {
    public static GamestateOne gamestate;
    public GameObject Popup;

    private Raider target;
    private CastBarOne castBar;
    private ManaBarOne manaBar;
    private GcdBarOne gcdBar;
    private Boss Boss;
    ...
    public void SetCastBar(CastBarOne bar)
    {
        castBar = bar;
    }
    ...
    public void SetManaBar(ManaBarOne bar)
    {
        manaBar = bar;
    }
    ...
    /// </summary>
    /// <param name="Bar">The bar.</param>
    public void SetGcdBar(GcdBarOne bar)
    {
        gcdBar = bar;
    }
